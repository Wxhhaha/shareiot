...
//							"appid=%s&secret=%s&code=%s&grant_type=authorization_code", Constant.WECHAT_APP_ID,
//					Constant.WECHAT_API_SECRET, code), NetworkUtil.GET_TOKEN);
//		}
//        finish();
	}
